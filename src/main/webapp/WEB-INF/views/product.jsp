...
<a href="${pageContext.request.contextPath}/product?category=${product.categoryName}&id=${product.id}"><c:out
        value="${pageContext.request.serverName}:${pageContext.request.serverPort}${pageContext.request.contextPath}
        /product?category=${product.categoryName}&id=${product.id}"/></a><br>
